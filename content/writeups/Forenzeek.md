...
categories = ["Forensic"]
tags = ["Medium"]
description = "Challenge de Forensic du FCSC 2026. Des logs réseau issues de l'outil Zeek ont été collectés sur un réseau dans lequel un attaquant a été repéré. Seule une partie des champs des logs de Zeek sont diponibles."
+++
